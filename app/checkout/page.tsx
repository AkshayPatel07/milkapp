      ...
      <div className="min-h-screen py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center py-12">
            ...
            <p className="text-foreground mb-8">Add some products before proceeding to checkout</p>
                  ...
                  >
                    <div className="flex items-center space-x-2 border rounded-lg p-4">
                      ...
                      <label htmlFor="cod" className="flex-1 cursor-pointer">
                        ...
                        <div className="text-sm text-foreground">Pay when you receive your order</div>
                      </label>
                    </div>
                    <div className="flex items-center space-x-2 border rounded-lg p-4 opacity-50">
                      ...
                      <label htmlFor="online" className="flex-1">
                        ...
                        <div className="text-sm text-foreground">Coming soon - UPI, Cards, Net Banking</div>
                      </label>
                    </div>
                  </RadioGroup>
                </CardContent>
