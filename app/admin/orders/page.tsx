...
export default function OrdersPage() {
  ...
  const filteredOrders = orders.filter((order) => {
    ...
    const matchesCity = cityFilter === "all" || order.delivery_city.toLowerCase() === cityFilter.toLowerCase()
    const matchesSearch =
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="space-y-1">
                    ...
                    <CardDescription>
                      {new Date(order.created_at).toLocaleDateString()} • {order.delivery_time}
                    </CardDescription>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Delivery Date: {order.delivery_date}</p>
                    </div>
                    {order.notes && (
                      <div>
